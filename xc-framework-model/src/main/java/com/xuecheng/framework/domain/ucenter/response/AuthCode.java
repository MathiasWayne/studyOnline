...
public enum AuthCode implements ResultCode {
    ...
    AUTH_CODE_ERROR(false,23007,"认证失败"),
    AUTH_SAVE_REDIS(false,23008,"保存reddis失败"),
    AUTH_SERVER_ERROR(false,23009,"获取服务地址失败"),
    AUTH_HTTP_ERROR(false,23010,"认证请求失败"),
    AUTH_JWT_ERROR(false,23011,"获取令牌失败");
    //操作代码
